    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                bitcoinURL = BASE_URL+ "BTC" + parent.getItemAtPosition(position);
                letsDoSomeNetworking(bitcoinURL, null);
    ...
    private void letsDoSomeNetworking(String url, RequestParams params) {
        ...
        client.get(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    price.setText(response.getString("ask"));
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                Log.d("Bitcoin" , "onFailure : "+statusCode);
            }
